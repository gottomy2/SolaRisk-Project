...
public class BasicInkExample : MonoBehaviour {
	...
	void RefreshView () {
		...
		// If we've read all the content and there's no choices, the story is finished!
			...
			Button choice = CreateChoiceView("Koniec Dialogu.\nPrzejdź Dalej");
	...
	Button CreateChoiceView (string text) {
		...
		choice.transform.SetParent (buttonsContainer.transform, false);
		...
		//GridLayoutGroup layoutGroup = choice.GetComponent <GridLayoutGroup> ();
	...
	void RemoveChildren () {
		...
		int textCount = textContainer.transform.childCount;
		int buttonsCount = buttonsContainer.transform.childCount;
		...
		{
			GameObject.Destroy(textContainer.transform.GetChild(i).gameObject);
		}
